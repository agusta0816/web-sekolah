	...
	<div class="article-title">
		<div class="share-block right">
			<div>
				<div class="share-article left">
					...
					<strong>Share ke sosial media</strong>
				</div>
				<div class="left">
					<script language="javascript">
					document.write("<a href='http://www.facebook.com/share.php?u=" + document.URL + " ' target='_blank' class='custom-soc icon-text'>&#62220;</a> <a href='http://twitter.com/home/?status=" + document.URL + "' target='_blank' class='custom-soc icon-text'>&#62217;</a>");
					</script>
				</div>
				<div class="clear-float"></div>
			</div>
			<div>
				<a href="javascript:printArticle();" class="small-button"><span class="icon-text">&#59158;</span>&nbsp;&nbsp;Print article</a>
				<a href="#" class="small-button"><span class="icon-text">&#9993;</span>&nbsp;&nbsp;Kirim ke e-mail</a>
			</div>
		</div>
		...
		<div class="author">
			...
			<div class="a-content">
				...
				<span class="meta"><?php echo tgl_indo($rows['tanggal']).", $rows[jam] WITA"; ?>
									...
									$komentar = $this->model_utama->view_where_ordering_limit('komentar',array('id_berita' => $rows['id_berita'],'aktif' => 'Y'),'id_komentar','ASC',0,100);
			  						foreach ($komentar->result_array() as $kka) {
										...
										echo "<div style='background:$warna' class='commment-content'>
												...
												<span class='time-stamp'>".tgl_indo($kka['tgl']).", $kka[jam_komentar] WITA</span>
